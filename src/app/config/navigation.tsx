...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    path: '/promociones',
    roles: ['comision_academica', 'comision_promocion', 'docente', 'talento_humano', 'comision_apelaciones']
  },
  {
    label: 'Postulaciones',
    icon: <CheckSquare className="w-5 h-5" />,
    path: '/postulaciones',
    roles: ['comision_academica', 'comision_promocion', 'docente', 'talento_humano']
  },
  {
    label: 'Apelaciones',
